...
public class Opening extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setUndecorated(true);
        setPreferredSize(new java.awt.Dimension(630, 402));
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon("C:\\Users\\HP\\Downloads\\images.jpg")); // NOI18N
        ...
        jLabel5.setText("Powered By Infinite Friend World");
    ...
    public static void main(String args[]) {
        ...
        try {
            for (int i=0; i<=100;i++) {
                Thread.sleep(10);
                o.jProgressBar1.setValue(i);
                o.jLabel2.setText(Integer.toString(i)+"%");
            }
        } catch (Exception e) {
        }
        new Opening().setVisible(false);
        l.setVisible(true);
        o.dispose();
    }
